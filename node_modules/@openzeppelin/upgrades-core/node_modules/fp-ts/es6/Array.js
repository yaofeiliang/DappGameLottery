 ...
 * @since 2.0.0
 */
export var makeBy = function (n, f) { return (n <= 0 ? [] : NEA.makeBy(n, f)); };
/**
 ...
 * @since 2.10.0
 */
export var matchLeft = function (onEmpty, onNonEmpty) { return function (as) {
 ...
 * @since 2.10.0
 */
export var matchRight = function (onEmpty, onNonEmpty) { return function (as) {
 ...
 * @since 2.0.0
 */
export var tail = function (as) { return (isNonEmpty(as) ? O.some(NEA.tail(as)) : O.none); };
/**
 ...
 * @since 2.0.0
 */
export var init = function (as) { return (isNonEmpty(as) ? O.some(NEA.init(as)) : O.none); };
/**
