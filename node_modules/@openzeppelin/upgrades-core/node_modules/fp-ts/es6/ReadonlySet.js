 ...
 * @since 2.5.0
 */
export var remove = function (E) { return function (a) { return function (set) {
 ...
 * @since 2.10.0
 */
export var fromReadonlyArray = function (E) { return function (as) {
    var len = as.length;
    var out = new Set();
    var has = elem(E);
    for (var i = 0; i < len; i++) {
 ...
 * @since 2.5.0
 */
export var some = function (predicate) { return function (set) {
    var values = set.values();
    var e;
    var found = false;
    // tslint:disable-next-line: strict-boolean-expressions
 ...
 * @since 2.5.0
 */
export var toReadonlyArray = function (O) { return function (set) {
    var out = [];
