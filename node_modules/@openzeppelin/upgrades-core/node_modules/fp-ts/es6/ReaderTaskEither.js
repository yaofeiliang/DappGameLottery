...
export var traverseArrayWithIndex = function (f) {
    return flow(R.traverseArrayWithIndex(f), R.map(TE.sequenceArray));
};
/**
 ...
 * @since 2.9.0
 */
export var traverseSeqArrayWithIndex = function (f) {
    return flow(R.traverseArrayWithIndex(f), R.map(TE.sequenceSeqArray));
};
/**
