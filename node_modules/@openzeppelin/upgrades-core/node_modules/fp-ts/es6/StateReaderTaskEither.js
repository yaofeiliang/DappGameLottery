 ...
 * @since 2.0.0
 */
export var get = function () { return function (s) { return RTE.of([s, s]); }; };
/**
 * Set the state
 *
 * @category constructors
 * @since 2.0.0
 */
export var put = function (s) { return function () { return RTE.of([undefined, s]); }; };
/**
 ...
 * @since 2.9.0
 */
export var traverseArrayWithIndex = function (f) { return function (as) { return function (s) { return function (r) { return function () {
    return as.reduce(function (acc, a, i) {
        return acc.then(function (ebs) {
            return E.isLeft(ebs)
                ? acc
                : f(i, a)(s)(r)().then(function (eb) {
                    if (E.isLeft(eb)) {
                        return eb;
                    }
