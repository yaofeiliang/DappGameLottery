import { apFirst as apFirst_, apSecond as apSecond_, apS as apS_ } from './Apply';
 ...
 * @since 2.9.0
 */
export var traverseArrayWithIndex = function (f) { return function (as) { return function (s) {
    var lastState = s;
    var values = [];
