 ...
 * @since 2.9.0
 */
export var traverseArrayWithIndex = function (f) { return function (as) { return function () { return Promise.all(as.map(function (x, i) { return f(i, x)(); })); }; }; };
/**
 ...
 * @since 2.9.0
 */
export var traverseSeqArrayWithIndex = function (f) { return function (as) { return function () {
