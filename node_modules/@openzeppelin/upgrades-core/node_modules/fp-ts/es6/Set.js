 ...
 * @since 2.0.0
 */
export var remove = function (E) { return function (a) { return function (set) { return filter(function (ax) { return !E.equals(a, ax); })(set); }; }; };
/**
 ...
 * @since 2.0.0
 */
export var toArray = function (O) { return function (set) {
    var out = [];
