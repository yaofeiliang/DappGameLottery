 ...
 * @since 2.5.0
 */
export var makeBy = function (n, f) { return (n <= 0 ? empty : RNEA.makeBy(n, f)); };
/**
 ...
 * @since 2.10.0
 */
export var matchLeft = function (onEmpty, onNonEmpty) { return function (as) { return (isNonEmpty(as) ? onNonEmpty(RNEA.head(as), RNEA.tail(as)) : onEmpty()); }; };
/**
 ...
 * @since 2.10.0
 */
export var matchRight = function (onEmpty, onNonEmpty) { return function (as) { return (isNonEmpty(as) ? onNonEmpty(RNEA.init(as), RNEA.last(as)) : onEmpty()); }; };
/**
 ...
 * @since 2.5.0
 */
export var head = function (as) { return (isNonEmpty(as) ? O.some(RNEA.head(as)) : O.none); };
/**
 ...
 * @since 2.5.0
 */
export var last = function (as) { return (isNonEmpty(as) ? O.some(RNEA.last(as)) : O.none); };
/**
...
export var tail = function (as) {
    return isNonEmpty(as) ? O.some(RNEA.tail(as)) : O.none;
};
/**
...
export var init = function (as) {
    return isNonEmpty(as) ? O.some(RNEA.init(as)) : O.none;
};
/**
 ...
 * @since 2.5.0
 */
export var dropLeftWhile = function (predicate) { return function (as) {
